 ...
 * @subpackage Resource
 * @see http://blog.vandenbos.org/2009/07/09/zend-framework-per-module-translation-sources/
 */

/**
 * Resource for loading translation configs
 *
 ...
 * @see http://blog.vandenbos.org/2009/07/09/zend-framework-per-module-translation-sources/
 */
class App_Application_Resource_Translate extends Zend_Application_Resource_ResourceAbstract
{
    ...
    {
        $this->_translate->addTranslation($data, $locale, $options);
    }
}