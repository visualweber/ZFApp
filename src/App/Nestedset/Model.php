 ...
 */
abstract class App_NestedSet_Model {
    ...
    public function add($name, $reference = null, $position = 'into') {
        if (is_null($reference)) {
            $builder = (new App_NestedSet_Model_Builder);
    ...
    public function getNodeWidth($elementId) {
        $builder = (new App_NestedSet_Model_Builder);
        return $builder->getNodeWidth($this, $elementId);
    }
    ...
    public function getLeafs() {
        $builder = (new App_NestedSet_Model_Reader);
        return $builder->getLeafs($this);
    }
    ...
    public function getAll($depth = null, $mode = 'include', $order = 'ASC') {
        $builder = (new App_NestedSet_Model_Reader);
        return $builder->getAll($this, $depth, $mode, $order);
    }
    ...
    public function toArray(array $nodes = array()) {
        ...
        $builder = (new App_NestedSet_Model_Output);
        return $builder->toArray($nodes);
    }
    ...
    public function toHtml(array $nodes = array(), $method = 'list') {
        ...
        $builder = (new App_NestedSet_Model_Output);
        return $builder->toHtml($nodes, $method);
    }
    ...
    public function getElement($elementId, $depth = null) {
        $builder = (new App_NestedSet_Model_Reader);
        return $builder->getElement($this, $elementId, $depth);
    }
    ...
    public function getPath($elementId, $order = 'ASC') {
        $builder = (new App_NestedSet_Model_Reader);
        return $builder->getPath($this, $elementId, $order);
    }
    ...
    public function getParent($elementId, $depth = 1) {
        $builder = (new App_NestedSet_Model_Reader);
        return $builder->getParent($this, $elementId, $depth);
    }
    ...
    public function numberOfDescendant($elementId) {
        ...
        $width = $builder->getNodeWidth($this, $elementId);
        $result = ($width - 2) / 2;
    ...
    public function isRoot($elementId) {
        $builder = (new App_NestedSet_Model_Reader);
        return $builder->isRoot($this, $elementId);
    }
