...
class App_NestedSet_Model_Builder {
     ...
     * @return $this
     */
    public function append(App_NestedSet_Model $nestedset, $name) {
        $db = $nestedset->getDb();
     ...
     * @return $this
     */
    public function moveInto(App_NestedSet_Model $nestedset, array $element, array $reference) {
        $db = $nestedset->getDb();
     ...
     * @return $this
     */
    public function deleteRecursive(App_NestedSet_Model $nestedset, array $tree) {
        $db = $nestedset->getDb();
