...
class App_Controller_Router_Route_RequestVars implements Zend_Controller_Router_Route_Interface {
    ...
    public function match($path) {
        ...
        if (array_key_exists('module', $params) || array_key_exists('controller', $params) || array_key_exists('action', $params)) {
    ...
    public function assemble($data = array(), $reset = false, $encode = false) {
        ...
        if (!array_key_exists('module', $data) && !$reset && array_key_exists('module', $this->_current) && $this->_current['module'] != $frontController->getDefaultModule()) {
