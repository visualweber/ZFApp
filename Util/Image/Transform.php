 ...
 * @see App_Image
 */
require_once 'Kernel/Image.php';

/**
 * @see App_Image_Transform_Exception
 */
require_once 'Kernel/Image/Transform/Exception.php';
 ...
 * @license   http://www.opensource.org/licenses/bsd-license.php New BSD License
 */
class App_Util_Image_Transform extends App_Image
{
    /**
     ...
     *
     * @throws App_Image_Driver_Exception
     * @throws App_Image_Transform_Exception
    ...
    public function fitToWidth( $targetWidth )
    {
        ...
        if( $sourceWidth <= 0 ) {
            throw new App_Image_Transform_Exception( 'Source width can\'t be 0' );
        }

        if( $sourceHeight <= 0 ) {
            throw new App_Image_Transform_Exception( 'Source height can\'t be 0' );
        }
    ...
    private function _checkOffsets()
    {
        if( $this->_leftOffset > 0 && $this->_rightOffset > 0 ) {
            throw new App_Image_Transform_Exception(
