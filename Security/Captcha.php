<?php
//		Captcha 
//		$objCapchar = new App_Security_Captcha();
//		$objCapchar->draw_lines = true;
//		$objCapchar->image_width 	= 59;
//		$objCapchar->image_height 	= 20;
//		$objCapchar->font_size		= 10;
//		$objCapchar->text_color	= '#cococo';
//		$objCapchar->text_angle_minimum = 0;
...
class App_Security_Captcha {
	...
	function __construct($code = NULL) {
		...
		$this->init ( $config_captcha );
		
		$this->gd_font_file = $path . '/Captcha/gdfonts/bubblebath.gdf';
		$this->ttf_file = $path . "/Captcha/gdfonts/elephant.ttf";
