...
class App_NestedSet_Model_Reader {
     ...
     * @return array
     */
    public function getAll(App_NestedSet_Model $nestedset, $depth = null, $mode = 'include', $order = 'ASC') {
        $db = $nestedset->getDb();
     ...
     * @return array
     */
    public function getElement(App_NestedSet_Model $nestedset, $elementId, $depth = null, $order = 'ASC') {
     ...
     * @return int
     */
    public function getNodeWidth(App_NestedSet_Model $nestedset, $elementId) {
        $db = $nestedset->getDb();
     ...
     * @return array
     */
    public function getLeafs(App_NestedSet_Model $nestedset) {
        $db = $nestedset->getDb();
     ...
     * @return array
     */
    public function getPath(App_NestedSet_Model $nestedset, $elementId, $order = 'ASC') {
        $db = $nestedset->getDb();
