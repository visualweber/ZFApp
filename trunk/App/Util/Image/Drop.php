 ...
 */
/*
 class Cute_Helper_ImageDrop extends Zend_Controller_Action_Helper_Abstract
 {
 ...
 */
class App_Util_Image_Drop
{
    public $_imgOrig = null;
    public $_imgFinal = null;
    public $_showDebug = true;
    public $gdInfo = array ();
    ...
    function App_Util_Image_Drop($debug = true)
    {
     ...
     * @access public
     */
    public function saveImage($filename, $quality = 100, $forcetype = '')
    {
        ...
        $ext = ($forcetype == '') ? $this->getExtension ( $filename ) : strtolower ( $forcetype );
     ...
     * @access public
     */
    public function showImage($type = 'png', $quality = 100)
    {
        if ($this->_imgFinal == null)
        {
     ...
     * @return bool
     */
    private function _cropSize($ox, $oy, $nx, $ny, $position)
    {
        if ($this->_imgOrig == null)
        {
     ...
     * @return array
     */
    private function _getCopyPosition($nx, $ny, $position)
    {
     ...
     * @return float
     */
    private function _getThresholdValue($im, $x, $y)
    {
     ...
     * @access private
     */
    private function _isSupported($filename, $extension, $function, $write = false)
    {
        //echo $extension;
