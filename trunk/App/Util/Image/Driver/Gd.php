...
/**
 * @see App_Image_Driver_Exception
 */
require_once 'Kernel/Image/Driver/Exception.php';


/**
 * @see App_Image_Driver_Abstract
 */
require_once 'Kernel/Image/Driver/Abstract.php';
 ...
 */
class App_Util_Image_Driver_Gd extends App_Image_Driver_Abstract
{
    /**
    ...
    {
        if( $this->_image === null ) {
            throw new App_Image_Driver_Exception(
