 ...
 */
class App_View_Smarty_Plugin_Broker {
	
	/**
	 * Array of instance of objects extending App_View_Smarty_Plugin_Abstract
	 *
	 * @var array
	 */
	 ...
	 * Register a plugin.
	 *
	 * @param  App_View_Smarty_Plugin_Abstract $plugin
	 * @param  int $stackIndex
	 * @return App_View_Smarty_Plugin_Broker
	 */
	public function registerPlugin(App_View_Smarty_Plugin_Abstract $plugin, $stackIndex = null) {
		if (false !== array_search ( $plugin, $this->_plugins, true )) {
			throw new App_View_Smarty_Exception ( 'Plugin already registered' );
		}
		...
		if ($stackIndex) {
			if (isset ( $this->_plugins [$stackIndex] )) {
				throw new App_View_Smarty_Exception ( 'Plugin with stackIndex "' . $stackIndex . '" already registered' );
			}
	...
	public function unregisterPlugin($plugin) {
		if ($plugin instanceof App_View_Smarty_Plugin_Abstract) {
			// Given a plugin object, find it in the array
			$key = array_search ( $plugin, $this->_plugins, true );
			if (false === $key) {
				throw new App_View_Smarty_Exception ( 'Plugin never registered.' );
			}
	 ...
	 * @return false|App_View_Smarty_Plugin_Abstract|array Returns false if none found, plugin if only one found, and array of plugins if multiple plugins of same class found
	 */
