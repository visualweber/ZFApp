 ...
 */
class App_View_Smarty_Plugin_Standard extends App_View_Smarty_Plugin_Abstract {
	
	public static function templateFunction($params, &$smarty) {
		$section = $params ['section'];
	}
	
	public static function geturlFunction($params, $smarty) {
	...
	public static function htmlifyFunction($params, $smarty) {
	...
	public static function headLinkFunction($params, &$smarty) {
		$method = (isset ( $params ['method'] )) ? $params ['method'] : - 1;
		$arg = $params ['arg'];
		unset ( $params ['method'] );
		$toReturn = "";
		try {
			if ($method != - 1) {
				@$toReturn = $smarty->_tpl_vars ['this']->headLink ()->$method ( $arg );
			} else {
				$toReturn = $smarty->_tpl_vars ['this']->headLink ();
			}
			return $toReturn;
		} catch ( Exception $e ) {
			return $toReturn;
