...
/**
 * Stream interface is designed to handle files as streams
 * where as the legacy App_Filesystem_File static class treated files in a rather
 * atomic manner.
 *
 * @package    App.Platform
 * @subpackage  FileSystem
 ...
 * @since       11.1
 */
class App_Filesystem_Stream extends App_Filesystem {
